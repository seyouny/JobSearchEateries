    ...
    $.ajax({
        ...
        $.ajax({
            ...
            for (var i = 0; i < 5; i++){
                ...
                restaurantResults.push({name: name, rating: rating, total_ratings: user_ratings_total, id: place_id, price: price_level});
            }
        ...
        $.ajax({
            ...
            for (var i = 0; i < 5; i++){
                ...
                place_id = response.results[i].place_id;
                price_level = response.results[i].price_level;
                cafeResults.push({name: name, rating: rating, total_ratings: user_ratings_total, id: place_id, price: price_level});
            }
           ...
           $.ajax({
               ...
               for (var i = 0; i < 5; i++){
                   ...
                   place_id = response.results[i].place_id;
                   price_level = response.results[i].price_level;
                   barResults.push({name: name, rating: rating, total_ratings: user_ratings_total, id: place_id, price: price_level});
               }
